...
By calling this function and comparing the result with the HMAC property received from Bank3D, you can ensure the authenticity and integrity of the data before proceeding with transaction processing.